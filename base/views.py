...
class IndexView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        total_properties_value = sum(property.value for property in properties)

        context = {
            "total_saving_accounts_balance": Money(
                total_saving_accounts_today, DEFAULT_CURRENCY
            ),
            "total_investment_accounts_balance": Money(
                total_investment_accounts_today, DEFAULT_CURRENCY
            ),
            "total_properties_value": Money(total_properties_value, DEFAULT_CURRENCY),
            "net_worth": Money(
