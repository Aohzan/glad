...
def test_index_view_with_custom_days(
    ...
    assert (
        abs(
            saving_account_context["progression"].difference
            - expected_saving_progression.difference
        )
        < 0.001
    )
    ...
    assert (
        abs(
            investment_account_context["progression"].difference
            - expected_investment_progression.difference
        )
        < 0.001
    )
    assert (
...
def test_index_view_context_structure(
    ...
    assert isinstance(saving_progression.difference, float)
    ...
    assert isinstance(investment_progression.difference, float)
