...
class TestChecklistFinancialCharges:
    ...
    def test_ok_when_loan_with_interest_entry(self, lmnp_property):
        """Loan with loan_interest ledger entry → ok."""
        _add_loan(lmnp_property, year=2024)
    ...
    def test_ok_when_loan_with_insurance_entry(self, lmnp_property):
        """Loan with loan_insurance ledger entry → ok."""
        _add_loan(lmnp_property, year=2024)
