...
- When the web app is added on the phone, ask if user must unlock it with biometrics (settings to enable in a setting view). If enabled, the user must unlock the app with biometrics each time he opens it
